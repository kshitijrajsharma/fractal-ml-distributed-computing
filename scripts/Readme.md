...
spark-submit --deploy-mode cluster --master yarn train.py --data "s3a://ubs-datasets/FRACTAL/data" --executor-cores 2 --num-executors 16 --executor-memory  8--driver-memory 8 --fraction 0.01
```
